...
//	}
	 ...
	 * @return Boolean
	 */
	public static boolean isStopFireByBlock(Double xs, Double ys, Double xe, Double ye, Double r,
			List<TankMapBlock> blocks) {
...
//        System.out.println("isStopFireByBlock: xs=" + xs + ", ys=" + ys + ", xe=" + xe + ", ye=" + ye + ", r=" + r );
	 ...
	 * @return Double
	 */
	private static Boolean judgeIsPointInRectangle(Double x, Double y, Double x1, Double y1, Double x2, Double y2,
	...
	public static Double calDistanceOfPointToLine(Double x, Double y, Double x1, Double y1, Double x2, Double y2) {
		...
		Double area = Math.sqrt(
				halfPerimeter * (halfPerimeter - lengthAB) * (halfPerimeter - lengthAC) * (halfPerimeter - lengthBC));
